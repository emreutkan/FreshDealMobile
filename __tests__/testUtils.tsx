...
import punishmentHistoryReducer from '@/src/redux/slices/PunishmentHistorySlice';
...
export function renderWithProviders(
    ...
    {
        initialState = {},
        // Use the actual store configuration for more realistic testing
        store = configureStore({
            reducer: {
                ...
                punishmentHistory: punishmentHistoryReducer,
            },
            ...
            preloadedState: {...defaultMockState, ...initialState}, // Apply initial state here
        }),
        ...renderOptions
    } = {}
) {
